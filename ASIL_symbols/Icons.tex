...
\begin{document}
	...
	\begin{tikzpicture}
	\node[draw=black,fill=green!30] at (0,0) {QM};
	\end{tikzpicture}
	
	\begin{tikzpicture}
	\node[draw=black,fill=green!30] at (0,0) {QM[A]};
	\end{tikzpicture}
	
	\begin{tikzpicture}
	\node[draw=black,fill=green!30] at (0,0) {QM[B]};
	\end{tikzpicture}					
	
	\begin{tikzpicture}
	\node[draw=black,fill=green!30] at (0,0) {QM[C]};
	\end{tikzpicture}		
	
	\begin{tikzpicture}
	\node[draw=black,fill=green!30] at (0,0) {QM[D]};
	\end{tikzpicture}	
	
	\begin{tikzpicture}
	\node[draw=black,fill=blue!60!white] at (0,0) {SG};
	\end{tikzpicture}
	...
	\begin{tikzpicture}
	\node[draw=black,fill=green] at (0,0) {PL a};
	\end{tikzpicture}	

	\begin{tikzpicture}
	\node[draw=black,fill=PineGreen] at (0,0) {PL b};
	\end{tikzpicture}
	
	\begin{tikzpicture}
	\node[draw=black,fill=yellow] at (0,0) {PL c};
	\end{tikzpicture}
	
	\begin{tikzpicture}
	\node[draw=black,fill=orange] at (0,0) {PL d};
	\end{tikzpicture}
	
	\begin{tikzpicture}
	\node[draw=black,fill=red] at (0,0) {PL e};
	\end{tikzpicture}
	
	% ISO 25119 Agricultural Performance Levels
	\begin{tikzpicture}
	\node[draw=black,fill=green] at (0,0) {AgPL a};
	\end{tikzpicture}	

	\begin{tikzpicture}
	\node[draw=black,fill=PineGreen] at (0,0) {AgPL b};
	\end{tikzpicture}

	\begin{tikzpicture}
	\node[draw=black,fill=yellow] at (0,0) {AgPL c};
	\end{tikzpicture}

	\begin{tikzpicture}
	\node[draw=black,fill=orange] at (0,0) {AgPL d};
	\end{tikzpicture}

	\begin{tikzpicture}
	\node[draw=black,fill=red] at (0,0) {AgPL e};
	\end{tikzpicture}	
